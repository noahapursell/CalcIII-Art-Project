...
class Leaf:
    ...
    def __init__(self, ellipse: Ellipse, height=0.1, num_holes:int = 3):
    ...
    def get_holes(self, num_holes) -> list:
        ...
        for i in range(num_holes):
            ...
            while needs_hole:
                ...
                v_ax = max(vertical_ax_min, random.uniform(vertical_ax_min, vertical_ax_max * scaling_factor))
                h_ax = max(horizontal_ax_min, random.uniform(horizontal_ax_min, horizontal_ax_max * scaling_factor))
